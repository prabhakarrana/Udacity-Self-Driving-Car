...
5. Once we are aware of other car's positions behaviour modelling is done and Code Explaination is below (line )
...
7.The following code snippet shows how we use the spine library to get the next wavepoints
8.Pushed these points into a vector (line ).
9.Filled intermediate paths points using spline line() and ref_velocity is also increased /decreased as per state conditions with a step of 0.224 line().
